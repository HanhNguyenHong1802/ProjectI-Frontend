...
import {
  Row, Card, CardImg, CardBody, CardTitle, Button, Modal, ModalHeader, ModalBody,
  Input, Label, Form, FormGroup, BreadcrumbItem, Breadcrumb, CardText
} from 'reactstrap';
...
class AddCommentForm extends Component {
  ...
  handleAddComment(event) {
    ...
    this.props.postComment({
      content: this.content.value, rating: this.rating.value,
      drink: this.props.drink._id
    });
  }
