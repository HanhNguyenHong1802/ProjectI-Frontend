...
import {
  login, logout, signup, deleteUser, postUser, getDrinks, postDrink,
  ...
  postMember, deleteMember, getOrders, postOrder, deleteOrder, updateOrder
    ...
    return (
      <div>
        ...
        <Switch>
          ...
          />} />
          <Route exact path="/order" component={() => <Order user={this.props.user}
            orders={this.props.orders}
            postOrder={this.props.postOrder}
            deleteOrder={this.props.deleteOrder}
            updateOrder={this.props.updateOrder} />}
